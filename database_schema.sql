...
-- Fund (must be created after group)
INSERT INTO SharedFund(GroupId, Balance, TargetAmount, Version, FundType, IsSpendable)
VALUES (1, 0, 0, 0, 'OPERATING', 1);
GO
...
-- Maintenance
INSERT INTO Maintenance (VehicleId, RequestedBy, ApprovedBy, Description, ActualCost, Status, CoverageType)
VALUES (1, 4, NULL, N'Battery health warning detected, awaiting review', 0, 'PENDING', 'GROUP'),
       (1, 4, 2, N'Tire pressure adjustment and brake check completed', 500000, 'APPROVED', 'GROUP'),
       (1, 4, 2, N'Body repaint request rejected due to non-essential cosmetic issue', 0, 'REJECTED', 'GROUP');
GO
...
-- Contract sample
INSERT INTO Contract(GroupId, StartDate, EndDate, Terms, RequiredDepositAmount, IsActive, ApprovalStatus,
                     ApprovedBy, ApprovedAt)
VALUES (1, '2024-01-01', '2025-01-01', N'Standard EV co-ownership contract terms...', 2000000, 1, 'APPROVED', 2,
        SYSUTCDATETIME());
GO
